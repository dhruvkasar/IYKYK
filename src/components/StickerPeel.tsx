...
const StickerPeel: React.FC<StickerPeelProps> = ({
  ...
  useEffect(() => {
    const updateLight = (e: MouseEvent) => {
      ...
      if (!rect || !pointLightRef.current || !pointLightFlippedRef.current) return;
      ...
      <div className="sticker-container" ref={containerRef}>
        <div className="sticker-main">
          <div className="sticker-lighting">
            <div className="sticker-image" style={{ width: typeof width === 'number' ? `${width}px` : width }}>
              {children}
            </div>
          </div>
        </div>
        ...
        <div className="flap">
          <div className="flap-lighting">
            <div className="flap-image" style={{ width: typeof width === 'number' ? `${width}px` : width }}>
              {children}
            </div>
          </div>
        </div>
